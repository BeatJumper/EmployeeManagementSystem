...
public class r_UpdateView extends JFrame {
    ...
    private DAO.rewardsDAO rewardsDAO = new rewardsDAO();


    public r_UpdateView(String rewards_ID) {
        setTitle("奖惩信息修改");
        ...
        saveBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                boolean flag = rewardsDAO.update(rewardsLog);
                if(flag){
                    dispose();
